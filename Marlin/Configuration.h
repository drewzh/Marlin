...
#define STRING_CONFIG_H_AUTHOR "(drewzh, me@drewzh.com)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.73, 79.73, 396.82, 415 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 38.2, -10, -2.30 }
...
#define X_MIN_POS 0
#define Y_MIN_POS -9.15 // BLV rails upgrade adjustment
#define Z_MIN_POS 0
...
#define ST7920 DELAY_1 DELAY_NS(0)
